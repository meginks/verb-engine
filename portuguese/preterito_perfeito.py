...
def eu_preterito_perfeito(infinitive):
...
def tu_preterito_perfeito(infinitive):
    verb_ending = get_infinitive_ending(infinitive)  
    verb_stem = get_verb_stem(infinitive)
    conjugated_form = ''
    if (verb_ending == ar):  
...
def voce_ele_ela_preterito_perfeito(infinitive): 
    verb_ending = get_infinitive_ending(infinitive)  
    verb_stem = get_verb_stem(infinitive)
    conjugated_form = ''
    if (verb_ending == ar):  
...
def nos_preterito_perfeito(infinitive): 
    verb_ending = get_infinitive_ending(infinitive)  
    verb_stem = get_verb_stem(infinitive)
    conjugated_form = ''
    if (verb_ending == ar):  
...
def vos_preterito_perfeito(infinitive): 
    conjugated_form = tu_preterito_imperfeito(infinitive) + 's'
    return conjugated_form  

def voces_eles_elas_preterito_perfeito(infinitive): 
    verb_ending = get_infinitive_ending(infinitive)  
    verb_stem = get_verb_stem(infinitive)
    conjugated_form = ''
    if (verb_ending == ar):  
...
def make_preterito_perfeito(infinitive): 
    return (eu_preterito_perfeito(infinitive),
            tu_preterito_perfeito(infinitive),
            voce_ele_ela_preterito_perfeito(infinitive),
            nos_preterito_perfeito(infinitive),
            vos_preterito_perfeito(infinitive),
            voces_eles_elas_preterito_perfeito(infinitive))